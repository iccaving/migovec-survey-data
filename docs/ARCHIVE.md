...
- Add labels  
  ...
  - scale s for labels to be shown on a cave but not full system map (eg. primadona_ubend_mona_tip, but not: sysem_migovec). Essentially these labels would clutter the general map appearing above or below passages.
