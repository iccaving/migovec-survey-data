...
shutil.rmtree(tmpdir) #remove temporarily generated xvi file, comment and print tmpdir to read it
...
{points}
endscrap""" #Scrap scale factor derived from 1:500 scale and 100 dots per inch resolution of xvi file
#Can be read from the "set XVIgrid" line of the xvi file which is temporarily generated by this script
